...
import head.config.Constants;
import head.HeadApp;
import head.domain.Authority;
import head.domain.User;
import head.repository.AuthorityRepository;
import head.repository.UserRepository;
import head.security.AuthoritiesConstants;
import head.service.MailService;
import head.service.dto.UserDTO;
import head.web.rest.errors.ExceptionTranslator;
import head.web.rest.vm.KeyAndPasswordVM;
import head.web.rest.vm.ManagedUserVM;
import head.service.UserService;
